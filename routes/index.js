...
// Define routes for deleting all data
router.post('/deleteActivityTable', deleteActivityTable);
router.post('/deleteActivityType', deleteActivityType);
router.post('/deleteAdmin', deleteAdmin);
router.post('/deleteMedicalRecord', deleteMedicalRecord);
router.post('/deleteOwner', deleteOwner);
router.post('/deletePet', deletePet);
router.post('/deleteReport', deleteReport);
router.post('/deleteSpecialization', deleteSpecialization);
router.post('/deleteVeterinarian', deleteVeterinarian);
